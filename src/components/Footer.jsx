      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6 text-xl md:2xl">
              Building excellence with integrity, quality, and innovative
              solutions since 2021.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-xl md:2xl">
              <li>
                {" "}
                Asian Highway 02, Kamrangaguri, Siliguri, Fulbari, West Bengal
                734015
              </li>
              <li>
                <a href="mailto:support@singhainfra.in?subject=Hello%20SinghInfra&body=Hello%2C%0A%0AI%20would%20like%20to%20know%20more%20about%20your%20services.">
                  support@singhainfra.in
                </a>
              </li>
        ...
        <div className="border-t border-gray-700 py-4 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} SinghaInfra Construction. All rights
            reserved.
          </p>
